...
import 'package:luvit/models/user/user_model.dart';
...
import '../../widgets/svg_asset_builder.dart';
                  ...
                  Draggable(
                    ...
                    feedback: Stack(
                      children: [
                        SizedBox(
                          width: constraints.maxWidth,
                          height: constraints.maxHeight,
                          child: imagePath.isNotEmpty ? AssetImageBuilder(
                            imagePath: imagePath,
                            fit: BoxFit.contain,
                          ) : SizedBox.shrink(),
                        ),
                    ...
                    child: Stack(
                      children: [
                        ...
                        imagePath.isNotEmpty ? _ImageCard(
                          user: user,
                          imagePath: imagePath,
                        ) : SizedBox.shrink()
                      ],
            ...
            Row(
              ...
              children: [
                ...
                const Align(
                    ...
                    child: SvgAssetBuilder(svg: favoriteIcon))
              ],
            ),
            verticalSpaceSmall,
            verticalSpaceSmall,
